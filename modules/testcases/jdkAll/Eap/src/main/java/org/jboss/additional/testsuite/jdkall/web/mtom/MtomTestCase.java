 ...
 */
package org.jboss.additional.testsuite.jdkall.web.mtom;
...
public class MtomTestCase {
    ...
    private final String serverLogPath = "surefire-reports/org.jboss.additional.testsuite.jdkall.web.mtom.MtomTestCase-output.txt";
    ...
    public void mtomTest() throws Exception {
        ...
        QName qname = new QName("http://mtom.web.jdkall.testsuite.additional.jboss.org/", "ImageServerImplService");
