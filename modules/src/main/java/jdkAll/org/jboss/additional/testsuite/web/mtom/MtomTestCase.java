 ...
 */
package org.jboss.additional.testsuite.web.mtom;
...
public class MtomTestCase {
    ...
    private final String serverLogPath = "surefire-reports/org.jboss.additional.testsuite.web.mtom.MtomTestCase-output.txt";
    ...
    public void mtomTest() throws Exception {
        ...
        QName qname = new QName("http://mtom.web.testsuite.additional.jboss.org/", "ImageServerImplService");
