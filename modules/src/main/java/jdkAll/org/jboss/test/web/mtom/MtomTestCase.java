...
public class MtomTestCase {
    ...
    private final String serverLogPath = "surefire-reports/org.jboss.test.web.mtom.MtomTestCase-output.txt";
    ...
    public void mtomTest() throws Exception {
        ...
        QName qname = new QName("http://mtom.web.test.jboss.org/", "ImageServerImplService");
