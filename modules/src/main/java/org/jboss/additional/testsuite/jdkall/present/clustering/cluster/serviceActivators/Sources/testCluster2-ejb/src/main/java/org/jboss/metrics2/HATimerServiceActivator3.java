 ...
 */
public class HATimerServiceActivator3 implements ServiceActivator {
    ...
    public void activate(ServiceActivatorContext context) {
        ...
        factory.createSingletonServiceBuilder(HATimerService3.SINGLETON_SERVICE_NAME3, service)
            /*
