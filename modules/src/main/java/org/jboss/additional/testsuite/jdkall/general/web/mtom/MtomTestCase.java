...
public class MtomTestCase {
    ...
    private final String serverLogPath = "surefire-reports/org.jboss.additional.testsuite.jdkall.general.web.mtom.MtomTestCase-output.txt";
    ...
    public void mtomTest() throws Exception {
        ...
        QName qname = new QName("http://mtom.web.general.jdkall.testsuite.additional.jboss.org/", "ImageServerImplService");
