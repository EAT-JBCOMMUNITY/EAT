 ...
 */
public class HATimerServiceActivator2 implements ServiceActivator {
    ...
    public void activate(ServiceActivatorContext context) {
        ...
        factory.createSingletonServiceBuilder(HATimerService2.SINGLETON_SERVICE_NAME2, service)
            /*
