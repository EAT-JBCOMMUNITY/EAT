...
@RunAsClient
//@apAdditionalTestsuite({"modules/testcases/jdkAll/Wildfly/logging/src/main/java","modules/testcases/jdkAll/Eap7/logging/src/main/java","modules/testcases/jdkAll/Eap70x/logging/src/main/java"})
public class LoggingServletTestCase {
    ...
    public static WebArchive deployment() {
        ...
        war.addClasses(HttpRequest.class, LoggingTestServlet.class);
        return war;
    }
