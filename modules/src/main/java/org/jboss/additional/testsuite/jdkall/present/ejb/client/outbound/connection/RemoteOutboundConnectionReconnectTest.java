...
@RunAsClient
@EAT({"modules/testcases/jdk11/Eap7Plus/ejb/src/main/java#7.4.14*7.4.15"})
public class RemoteOutboundConnectionReconnectTest {
    ...
    private final String serverLogPath2 = "../../../../../servers/eap7/build/target/jbossas2/standalone/log/server.log";
    ...
    public void testRemoteServerStartsLate() throws Exception {
		...
		try {
		 ...
		 //   System.out.println(path + "========== " + everything);
		    Assert.assertTrue(everything.contains("Connection attempt to"));
		} finally {
		    inputStream.close();
		}
        } finally {
