...
@RunAsClient
@EAT({"modules/testcases/jdkAll/WildflyRelease-24.0.0.Final/ejb/src/main/java","modules/testcases/jdkAll/Wildfly/ejb/src/main/java#13.0.0","modules/testcases/jdkAll/WildflyJakarta/ejb/src/main/java#27.0.0.Alpha4","modules/testcases/jdkAll/WildflyRelease-27.0.0.Final/ejb/src/main/java","modules/testcases/jdkAll/WildflyRelease-20.0.0.Final/ejb/src/main/java","modules/testcases/jdkAll/Eap72x/ejb/src/main/java","modules/testcases/jdkAll/Eap72x-Proposed/ejb/src/main/java","modules/testcases/jdkAll/Eap71x/ejb/src/main/java","modules/testcases/jdk11/Eap7Plus/ejb/src/main/java#7.0.0*7.4.15"})
public class RemoteOutboundConnectionReconnectTestCase {
    ...
    public void before() throws Exception {
        ...
        this.context = createNamingContext(ejbClientProperties);
    }
    ...
    public static Archive<?> createContainer2Deployment() {
        ...
        ejbJar.addAsManifestResource("jboss-ejb-client.xml", "jboss-ejb-client.xml");
        return ejbJar;
    }
    ...
    private static Properties setupEJBClientProperties() throws IOException {
        ...
        final String clientPropertiesFile = s + "/src/test/resources/jboss-ejb-client.properties";
        final InputStream inputStream = new FileInputStream(clientPropertiesFile);
        if (inputStream == null) {
     ...
     */
    private Context createNamingContext(final Properties properties) throws NamingException {
