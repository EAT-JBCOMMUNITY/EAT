/*
 * Copyright (C) 2013 2013 Red Hat, Inc. and individual contributors
 ...
 * MA 02110-1301  USA
 */
package org.jboss.additional.testsuite.jdkall.past.eap_6_4_x.management.cli.session;
...
public class LongProcessingServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            Thread.sleep(getTimeout(request));
        } catch (InterruptedException ex) {
            Logger.getLogger(LongProcessingServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet CaseSupportServlet</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet CaseSupportServlet at " + request.getContextPath() + "</h1>");
    ...
    private long getTimeout(HttpServletRequest request) {
