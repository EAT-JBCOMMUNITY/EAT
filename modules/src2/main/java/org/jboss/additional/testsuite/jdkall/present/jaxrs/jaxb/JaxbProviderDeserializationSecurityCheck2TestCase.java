...
public class JaxbProviderDeserializationSecurityCheck2TestCase {

    @Deployment(testable = false)
    public static Archive<?> deploy() {
        WebArchive war = ShrinkWrap.create(WebArchive.class,"jaxrssecurity2.war");
        war.addPackage(HttpRequest.class.getPackage());
        war.addClasses(JaxbProviderDeserializationSecurityCheck2TestCase.class, JaxbResourceDeserializationSecurityCheck2.class,ExampleApplication.class,
