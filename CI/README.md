...
$ sudo docker run --name atci -e TEST_PROGRAM=(e.g. wildfly,openliberty,etc) (-e AT_PR=75) (-e PROGRAM_PR=100) (-e GITHUB_TOKEN=the AT github token, used to send the result message to the PR tested) (-e PROGRAM_BRANCH=the branch of the program to be tested) --ulimit nofile=5000:5000 docker.io/atci
```
