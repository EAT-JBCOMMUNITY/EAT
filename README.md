...
5. NEXT GENERATION AT STRUCTURES : The tests should be independent modules that will have dependencies on libraries and other tests. The tool should compose the appropriate test cases and distribute them to the appropriate subcategories.
